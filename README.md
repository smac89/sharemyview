...
```
cd existing_repo
git remote add origin https://gitlab.com/firstairbender/sharemyview/capture.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/firstairbender/sharemyview/capture/-/settings/integrations)
